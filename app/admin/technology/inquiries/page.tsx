...
import { Mail, Clock, CheckCircle, Loader2, MessageSquare, Phone, Building2 } from "lucide-react";
...
export default function AdminTechInquiriesPage() {
    ...
    return (
        <div className="p-8">
            <div className="mb-8">
                <h1 className="text-3xl font-black uppercase text-black">Technology Inquiries</h1>
                <p className="text-gray-500">Software development and digital solution leads.</p>
            </div>
                            ...
                            <div key={inquiry.id} className="bg-white border-l-4 border-black p-6 shadow-sm hover:shadow-md transition-shadow relative">
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="text-lg font-bold flex items-center">
                                        ...
                                        {inquiry.company || "Individual Client"}
                                    </h3>
